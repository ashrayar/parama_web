...
def BringToZero(tempatoms,prepro,tempphi,temppsi):
    ...
    tempatoms['HA1']=resultantpoint(dircos[0],dircos[1],dircos[2],tempatoms['N2'][0],tempatoms['N2'][1],tempatoms['N2'][2],tempatoms['HA1'][0],tempatoms['HA1'][1],tempatoms['HA1'][2],-tempphi)
    ...
    tempatoms['HA2']=resultantpoint(dircos[0],dircos[1],dircos[2],tempatoms['N2'][0],tempatoms['N2'][1],tempatoms['N2'][2],tempatoms['HA2'][0],tempatoms['HA2'][1],tempatoms['HA2'][2],-tempphi)
...
def Gly_MapsGenerator(atoms,pdb_id,chain_id,resname,resnumber,prepro):
...
#                sampleout.write('CA1...H3 : '+res+'\n')
            res=CheckShortContacts(atoms['C1'],atoms['HA2'],2.40,2.20)
            finalres=finalres+res[0]
#            if res[0]=='p' or res[0]=='d':
#                sampleout.write('C1...HA2 : '+res+'\n')
...
#                sampleout.write('C1...H3 : '+res+'\n')
            res=CheckShortContacts(atoms['C1'],atoms['HA1'],2.40,2.20)
            finalres=finalres+res[0]
#            if res[0]=='p' or res[0]=='d':
#                sampleout.write('C1...HA1 : '+res+'\n')
            
            res=CheckShortContacts(atoms['O1'],atoms['HA1'],2.40,2.20)
            finalres=finalres+res[0]
#            if res[0]=='p' or res[0]=='d':
#                sampleout.write('O1...HA1 : '+res+'\n')
            res=CheckShortContacts(atoms['O1'],atoms['HA2'],2.40,2.20)
            finalres=finalres+res[0]
#            if res[0]=='p' or res[0]=='d':
#                sampleout.write('O1...HA2 : '+res+'\n')
...
#                sampleout.write('N2...H3 : '+res+'\n')
            ...
            res=CheckShortContacts(atoms['H2'],atoms['HA2'],2.00,1.90)
            finalres=finalres+res[0]
#            if res[0]=='p' or res[0]=='d':
#                sampleout.write('H2...HA2 : '+res+'\n')   
...
#                sampleout.write('H2...H3 : '+res+'\n')
            res=CheckShortContacts(atoms['H2'],atoms['HA1'],2.00,1.90)
            finalres=finalres+res[0]
#            if res[0]=='p' or res[0]=='d':
#                sampleout.write('H2...HA1 : '+res+'\n')
            
            res=CheckShortContacts(atoms['HA1'],atoms['O2'],2.40,2.20)
            finalres=finalres+res[0]
#            if res[0]=='p' or res[0]=='d':
#                sampleout.write('HA1...O2 : '+res+'\n')
            res=CheckShortContacts(atoms['HA1'],atoms['N3'],2.40,2.20)
            finalres=finalres+res[0]
#            if res[0]=='p' or res[0]=='d':
#                sampleout.write('HA1...N3 : '+res+'\n')
            if prepro=="normal":
                res=CheckShortContacts(atoms['HA1'],atoms['H3'],2.00,1.90)
            else:
                res=CheckShortContacts(atoms['HA1'],atoms['CD3'],2.40,2.20)
            finalres=finalres+res[0]
#            if res[0]=='p' or res[0]=='d':
#                sampleout.write('HA1...H3 : '+res+'\n')
            
            res=CheckShortContacts(atoms['HA2'],atoms['O2'],2.40,2.20)
            finalres=finalres+res[0]
#            if res[0]=='p' or res[0]=='d':
#                sampleout.write('HA2...O2 : '+res+'\n')
            
            res=CheckShortContacts(atoms['HA2'],atoms['N3'],2.40,2.20)
            finalres=finalres+res[0]
#            if res[0]=='p' or res[0]=='d':
#                sampleout.write('HA2...N3 : '+res+'\n')
            if prepro=="normal":
                res=CheckShortContacts(atoms['HA2'],atoms['H3'],2.00,1.90)
            else:
                res=CheckShortContacts(atoms['HA2'],atoms['CD3'],2.40,2.20)
            finalres=finalres+res[0]
#            if res[0]=='p' or res[0]=='d':
#                sampleout.write('HA2...H3 : '+res+'\n')
...
#                digimapfile.write(str(phi)+","+str(psi)+",2\n") 
        ...
        atoms['HA1']=resultantpoint(dircos[0],dircos[1],dircos[2],atoms['N2'][0],atoms['N2'][1],atoms['N2'][2],atoms['HA1'][0],atoms['HA1'][1],atoms['HA1'][2],1)
        ...
        atoms['HA2']=resultantpoint(dircos[0],dircos[1],dircos[2],atoms['N2'][0],atoms['N2'][1],atoms['N2'][2],atoms['HA2'][0],atoms['HA2'][1],atoms['HA2'][2],1)
